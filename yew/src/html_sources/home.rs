    ...
    html! {
        <body>
            ...
            <div class="main">
                ...
                <div class="sidebar2">
                    <div>
                        <svg viewBox="0 0 1024 1024" fill="currentColor" height="1em" width="1em" ><defs><style /></defs><path d="M482 152h60q8 0 8 8v704q0 8-8 8h-60q-8 0-8-8V160q0-8 8-8z" /><path d="M176 474h672q8 0 8 8v60q0 8-8 8H176q-8 0-8-8v-60q0-8 8-8z" /></svg>
                    </div>
                    <div class="sidebar2item">{"API 1"}</div>
                    <div class="sidebar2item">{"API 2"}</div>
                    <div class="sidebar2item">{"API 3"}</div>
                </div>
                ...
                <div class="content">
                    <div>
                        <div class="requestbar">
                            <div class="">
                                <select class="round" name="method" id="method">
                            ...
                            <div>
                                <input class="urlinput" type="text" id="fname" name="fname" />
                            </div>

                            <button class="sendbtn" type="button" onclick={ctx.link().callback(|_| Msg::SendPressed)}>{"Send"}</button>
                        </div>
                        ...
                        <div>
                            <textarea class="responseinput" rows = "5" cols = "60" value={sel.response.clone()} name = "description">
                                {"Enter details here..."}
                            </textarea>
                        </div>
                    </div>
